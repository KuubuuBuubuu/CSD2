...
LowPassFilter::LowPassFilter(float iCutOffFrequency) : output(0),
...
float LowPassFilter::updateFilter(float input)
{
	return output += (input - output) * ePow;
}

float LowPassFilter::updateFilter(float input, float deltaTime)
{
